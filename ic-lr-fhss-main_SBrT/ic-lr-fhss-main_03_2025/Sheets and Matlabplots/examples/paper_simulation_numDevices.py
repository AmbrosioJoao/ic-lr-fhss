...
df = pd.DataFrame({'Goodput_case1': goodput_case1, 'Goodput_case2': goodput_case2, 'Goodput_case3': goodput_case3, 'Goodput_case4': goodput_case4}, index = nNodes)
df.to_csv('Goodput_nodes.csv', index=False)

df = pd.DataFrame({'AoI_case1': AoI_case1, 'AoI_case2': AoI_case2, 'AoI_case3': AoI_case3, 'AoI_case4': AoI_case4}, index = nNodes)
df.to_csv('AoI_nodes.csv', index=False)
