function [Energy_Efficiency] = theoretical_DR_ee(devices, headers, header_duration, CR, payload_duration, transceiver_wait, c, l, lambda, tx_power)%==========================================================================
...
Energy_Efficiency = Goodput/(tx_power*(devices*(1/lambda)*(headers*header_duration+f*payload_duration)));