...
for n in nNodes:
    ...
    #CUSTOM - 1
    s = Settings(number_nodes = n, code = '5/6', headers=1, tx_power=10, delta = 1, traffic_param = {'average_interval': 900}, header_duration = 0.233472, payload_duration = 0.100)
...
#    results_1 = Parallel(n_jobs=8) (delayed(run_sim)(s, seed = seed) for seed in range(0,loops))
    ...
    headers_average_1 = s.delta*s.headers
    threshold_average_1 = threshold_1 * s.delta
    traffic_param_1 = 900
    ...
    #DR9
    s = Settings(number_nodes = n, code = '2/3', headers=2, tx_power=10, delta = 1, traffic_param = {'average_interval': 900}, header_duration = 0.233472, payload_duration = 0.100)
    #This line runs the simulation loops in paralel, using n_jobs as the number of threads generated.
    #Consider using a number according to the amount of reseources available to your machine to avoid crashing your system.
 ...
 #   results_2 = Parallel(n_jobs=8) (delayed(run_sim)(s, seed = seed) for seed in range(0,loops))
    ...
    headers_average_2 = s.delta*s.headers
    threshold_average_2 = threshold_2 * s.delta
    traffic_param_2 = 900
    ...
    #CUSTOM 2
    s = Settings(number_nodes = n, code = '1/2', headers=2, tx_power=10, delta = 1, traffic_param = {'average_interval': 900}, header_duration = 0.233472, payload_duration = 0.100)
    #This line runs the simulation loops in paralel, using n_jobs as the number of threads generated.
    #Consider using a number according to the amount of reseources available to your machine to avoid crashing your system.
 ...
 #   results_3 = Parallel(n_jobs=8) (delayed(run_sim)(s, seed = seed) for seed in range(0,loops))
    ...
    headers_average_3 = s.delta*s.headers
    threshold_average_3 = threshold_3 * s.delta
    traffic_param_3 = 900
    ...
    #DR8
    s = Settings(number_nodes = n, code = '1/3', headers=3, tx_power=10, delta = 1, traffic_param = {'average_interval': 900}, header_duration = 0.233472, payload_duration = 0.100)
    #This line runs the simulation loops in paralel, using n_jobs as the number of threads generated.
    #Consider using a number according to the amount of reseources available to your machine to avoid crashing your system.
 ...
 #   results_4 = Parallel(n_jobs=8) (delayed(run_sim)(s, seed = seed) for seed in range(0,loops))
    ...
    headers_average_4 = s.delta*s.headers
    threshold_average_4 = threshold_3 * s.delta
    traffic_param_4 = 900
