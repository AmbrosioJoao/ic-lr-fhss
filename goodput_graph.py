...
for n in nNodes:
  ...
  # Resultados do gráfico A:
    ...
    aoI_media_a1 = np.mean(results_a1, 0)[0] # Índice 5 para AoI_media
    aoI_media_b1 = np.mean(results_b1, 0)[0] # Índice 5 para AoI_media
    aoI_media_c1 = np.mean(results_c1, 0)[0] # Índice 5 para AoI_media
    aoI_media_d1 = np.mean(results_d1, 0)[0] # Índice 5 para AoI_media
...
aoi_int_a1 = int(example_a1['Goodput'])
aoi_int_b1 = int(example_b1['Goodput'])
aoi_int_c1 = int(example_c1['Goodput'])
aoi_int_d1 = int(example_d1['Goodput'])
